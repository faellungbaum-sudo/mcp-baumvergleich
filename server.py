#!/usr/bin/env python3
"""
MCP Server for Baumvergleich.de
Exposes tree care company data to AI assistants (Claude, ChatGPT, etc.)

When someone asks "Welchen Baumpfleger gibt es in Berlin?" — the AI can
query this server and return real data from our database.

Install: pip install mcp supabase
...
SUPABASE_URL = "https://trvtrnlyxpbbqbsinpyd.supabase.co"
SUPABASE_KEY = os.environ.get("SUPABASE_ANON_KEY", "REMOVED_USE_ENV_VAR")
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "service": {
                        ...
                        "enum": ["baumfaellung", "baumpflege", "stubbenentfernung", "baumgutachten", "notdienst", "obstbaumschnitt", "kronensicherung", "heckenschnitt", "rodung", "pflanzung"]
                    },
                    "limit": {
                        "type": "integer",
            ...
            inputSchema={
                ...
                "properties": {
                    "service": {
                        ...
                        "enum": ["baumfaellung", "baumpflege", "stubbenentfernung", "baumgutachten", "notdienst", "obstbaumschnitt"]
                    }
                },
                "required": ["service"]
            }
